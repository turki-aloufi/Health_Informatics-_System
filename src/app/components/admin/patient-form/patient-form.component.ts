    ...
    <div class="p-4 h-full">
      ...
      <form #patientForm="ngForm" (ngSubmit)="onSubmit()">
        ...
        <div class="mb-3" *ngIf="id">
          ...
          <input
            pInputText
            [(ngModel)]="patient.patientProfile.medicalHistory"
            name="medicalHistory"
          />
        </div>
        <div class="mb-3" *ngIf="id">
          ...
          <input
            pInputText
            [(ngModel)]="patient.patientProfile.insuranceDetails"
        ...
        <div class="mb-3" *ngIf="id">
          ...
          <input
            pInputText
            [(ngModel)]="patient.patientProfile.emergencyContact"
...
export class PatientFormComponent implements OnInit {
  ...
  onSubmit() {
    ...
    if (this.id) {
      this.store.dispatch(
        PatientActions.updatePatient({ id: this.id, patientData }),
      )
    } else {
