      ...
      <div *ngIf="!loading" class="grid">
        ...
        <div class="col-span-2">
          <p-card header="Patient Demographics" styleClass="h-full shadow-2">
            <div class="mb-3">
              <h3 class="text-base md:text-lg font-medium mb-2">
                Gender Distribution
              </h3>
              <div class="chart-container">
                <p-chart
        ...
        <div class="col-span-2">
          <p-card header="Doctor Workload" styleClass="h-full shadow-2">
            ...
            >
              ...
              <div
                *ngIf="!doctorWorkload || doctorWorkload.length === 0"
...
export class AdminDashboardComponent implements OnInit {
  ...
  createGenderDistributionChart(): void {
    if (
      !this.patientsDemographics ||
      !this.patientsDemographics.genderDistribution
    )
      return
  ...
  createAgeDistributionChart(): void {
    if (
      !this.patientsDemographics ||
      !this.patientsDemographics.ageDistribution
    )
      return
