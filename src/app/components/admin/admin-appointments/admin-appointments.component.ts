// // src/app/components/admin/admin-appointments/admin-appointments.component.ts
...
//             <tr>
//               <td>{{ i + 1 }}</td>
//               <td>{{ appointment.patientProfile?.user.name || 'Unknown' }}</td>
//               <td>{{ appointment.doctorProfile?.user.name || 'Unknown' }}</td>
...
//       message: `Are you sure you want to delete the appointment for ${appointment.patientProfile?.user.name || 'this patient'}?`,
